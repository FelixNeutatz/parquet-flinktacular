...
public class CSVToParquet {
    ...
    private static boolean parseParameters(String[] programArguments) {
        ...
        if(programArguments.length > 0) {
            if(programArguments.length == 4) {
                ...
                System.err.println("Usage: CSVToParquet <date_dim-csv path> <store_sales-csv path> <item-csv path> <result path>");
                return false;
            }
        } else {
    ...
    public static class ItemString extends Tuple22<Long, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String> {}
	
	public static class StoreSalesString extends Tuple23<String, String, Long, String, String, String, String, String, String, Long, String, String, String, String, String, String, String, String, String, String, String, String, String> {}
    ...
    private static DataSet<DateDimString> getDateDimDataSet(ExecutionEnvironment env) {
        return env.readCsvFile(dateDimPath)
                .fieldDelimiter('|')
                .pojoType(DateDimString.class, new String[]{"f0", "f1", "f2", "f3", "f4", "f5", "f6", "f7", "f8", "f9", "f10", "f11", "f12", "f13", "f14", "f15", "f16", "f17", "f18", "f19", "f20", "f21", "f22", "f23", "f24", "f25", "f26", "f27"});
    }
