 ...
 *
 *  <p>
 * Usage: <code>TPCDSQuery55Parquet &lt;lineitem-parquet path&gt; &lt;customer-parquet path&gt; &lt;orders-parquet path&gt; &lt;result path&gt;</code><br>
 *  
 * <p>
...
public class TPCDSQuery55Parquet {  
	...
	public static void main(String[] args) throws Exception {
		...
		// execute program
		env.execute("TPC_DS Query 55 Example with Parquet input");		
	...
	private static DataSet<Tuple2<Void, DateDimTable>> getDataDimDataSet(ExecutionEnvironment env) throws IOException {
		...
		HadoopInputFormat hadoopInputFormat = new HadoopInputFormat(new ParquetThriftInputFormat(), Void.class, DateDimTable.class, job);
	...
	private static DataSet<Tuple2<Void, StoreSalesTable>> getStoreSalesDataSet(ExecutionEnvironment env) throws IOException {
		Job job = Job.getInstance();
		...
		HadoopInputFormat hadoopInputFormat = new HadoopInputFormat(new ParquetThriftInputFormat(), Void.class, StoreSalesTable.class, job);
    ...
    private static DataSet<Tuple2<Void, ItemTable>> getItemDataSet(ExecutionEnvironment env) throws IOException {
		...
		HadoopInputFormat hadoopInputFormat = new HadoopInputFormat(new ParquetThriftInputFormat(), Void.class, ItemTable.class, job);
